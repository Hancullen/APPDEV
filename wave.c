...
// printID() and fillID() are so-called local functoins because 
// they are merely used by the functions in this file/module
...
#ifdef DEBUG // conditional compliling
